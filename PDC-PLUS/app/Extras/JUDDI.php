...
class JUDDI {
    ...
    private $SERVIDOR_JUDDI = "http://localhost:8080";
    //private $SERVIDOR_JUDDI = "http://192.168.43.246:8080";
    ...
    function getBinding($nome_servico) {
        ...
        $soap_inquiry = new SoapClient("http://localhost:8080/juddiv3/services/inquiry?wsdl");
        //$soap_inquiry = new SoapClient("http://192.168.43.246:8080/juddiv3/services/inquiry?wsdl");
